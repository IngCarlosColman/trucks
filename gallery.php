    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                <h2>Galería</h2>
                <h4>Imágenes excepcionales merecen una presentación excepcional.</h4>
            </div>
	...
	<div class="container">
		<div class="inner-page portfolio-container row">
			...
			<div class="portfolioContainer portfolio_3">
				<?php
				$directory="images/enumerado";
				$gdirectory="images/enumeradog";
				$dirint = dir($directory);
				while (($archivo = $dirint->read()) !== false)
				{
					if (eregi("gif", $archivo) || eregi("jpg", $archivo) || eregi("png", $archivo)){
						echo '<div class="col-md-4 col-sm-6 col-xs-12 convertible sports-car mix margin-bottom-30">'."\n";
						echo '<div class="box clearfix"> <a class="fancybox" href="'.$gdirectory."/".$archivo.'"><img class="image" src="'.$directory."/".$archivo.'" alt="" /></a> </div> '."\n";           
						echo '</div>'."\n";
					}
				}
				$dirint->close();
